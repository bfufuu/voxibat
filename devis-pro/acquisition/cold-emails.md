...
2. Pages Jaunes → pagesjaunes.fr → filtrer par métier + département
3. Societe.com → recherche par code NAF (4322A plomberie, 4321A électricité, etc.)
4. Annuaire des entreprises → entreprises.gouv.fr

Objectif : 50 emails/jour × 5 jours = 250 prospects pour commencer

---

## EMAIL 1 — Premier contact (J+0)

**Objet :** Vos factures seront-elles refusées en septembre 2026 ?

> Bonjour [Prénom],
>
> Je contacte les artisans [métier] de [région] au sujet de l'obligation de facturation électronique qui entre en vigueur le 1er septembre 2026.
>
...
**Objet :** Re: Ce que j'aurais dû vous préciser
...
> 3. Vous vérifiez et ajustez en 2 minutes
> 4. Vous envoyez un devis professionnel PDF
> 5. Si le client accepte → facture créée en 1 clic, conforme Factur-X 2026
>
> Résultat moyen : 2h de travail administratif économisées par semaine.
>
...
## EMAIL 3 — L'urgence (J+7)

**Objet :** 87 jours avant l'obligation légale

***(À envoyer en septembre 2026 remplacer le chiffre par le décompte réel)***

> Bonjour [Prénom],
>
> Il reste exactement 87 jours avant que la facturation électronique devienne obligatoire en France.
>
> Je ne veux pas vous faire peur, mais je veux être direct :
> les artisans qui attendent la dernière minute vont se retrouver à gérer une migration en urgence, pendant une période où ils ont des chantiers à gérer.
>
...
## Outil recommandé pour envoyer
- **Lemlist** — 50€/mois, envoie les séquences automatiquement, personnalisation [Prénom] [métier]
- **Brevo** (ex-Sendinblue) — plan gratuit jusqu'à 300 emails/jour
- **Mailreach** — pour éviter les spams

## Taux attendus
- Taux d'ouverture : 40-60% (objet sur la conformité légale = curiosité forte)
- Taux de réponse : 5-10%
- Taux de conversion essai : 2-4%
- Sur 250 emails → 5 à 10 essais → 2 à 4 clients

## Personnalisations importantes
Remplacer dans chaque email :
- [métier] → plombier / électricien / peintre / maçon
- [région] → votre département ou région
- Adapter l'exemple du devis (email 2) au métier ciblé
