                ...
                <div key={i} className="border border-gray-200 rounded-lg p-3 space-y-2">
                  <div className="flex gap-2">
                    <textarea
                      ...
                      rows={2}
                      className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
                    />
                    <button onClick={() => removeLigne(i)} className="text-red-400 hover:text-red-600 px-2 text-lg self-start pt-1">✕</button>
                  </div>
